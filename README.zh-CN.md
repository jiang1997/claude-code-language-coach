...
**安装命令：**
```text
/plugin add https://github.com/jiang1997/claude-code-language-coach --path plugins/language-coach
```
...
**安装命令：**
```text
/plugin add https://github.com/jiang1997/claude-code-language-coach --path plugins/language-coach-statusline
```
